                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $r['apellido_cli'] . ', ' . $r['nombre_cli'] ?></td>
                                            <td>
                                                <?php echo $r['dni_cli']; ?> 
                                           ...
                                           <td class="<?php echo ($r['estado_ma'] == 'ACTIVO') ? 'tdactivo' : 'tdculminado'; ?>"> <p><?php echo $estado ?></p> </td>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select form-select-sm mb-3" name="lstmembresia" id="membresia_u" onchange="actualizarPrecio_U()" required>
                                    ...
                                    while ($r = mysqli_fetch_assoc($f)) {
                                    ?>
                                        <option value="<?php echo $r['id_me'] ?>" 
                                        data-time="<?php echo $r['duracion_me'];  ?>">
