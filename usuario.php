                    ...
                    <tbody>
                        ...
                        while ($r = mysqli_fetch_assoc($f)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-lg btn-primary btn-circle"
                                        data-bs-toggle="modal" data-bs-target="#modalEditar" data-bs-whatever="@mdo"
                                        target="_parent"
                                        onclick="cargar_info({
                                    ...
                                    <a href="usuario/D_usuario.php?cod=<?php echo $r['id_us'] ?>"
                                        class="btn btn-lg btn-danger" target="parent"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php
                        }
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select form-select-sm mb-3" name="lstrol" id="rol" required>
                                    ...
                                    ?>
                                         <option value="<?php echo $r['nombre_ro'] ?>" <?php echo $selected ?>
                                           data-id-rol="<?php echo $r['id_ro'] ?>"><?php echo $r['nombre_ro'] ?>
                                        </option>
                                    <?php
                                    }
                                    ?>
