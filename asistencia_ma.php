...
<div class="main-content">
        <div>
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link text-dark active" id="regispro-tab" data-toggle="tab" href="#regispro">Registro De Matriculas Hoy</a>
                </li>
                <li class="nav-item">
                    <a  class="nav-link text-dark" id="detpro-tab" data-toggle="tab" href="#detpro">Registro de Matriculas del Mes</a>
                </li>
            </ul>
        </div>
</div>
